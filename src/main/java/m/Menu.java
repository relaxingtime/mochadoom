...
import config.language.englsh;
import static config.language.englsh.DOSY;
import static config.language.englsh.EMPTYSTRING;
import static config.language.englsh.ENDGAME;
import static config.language.englsh.GAMMALVL0;
import static config.language.englsh.GAMMALVL1;
import static config.language.englsh.GAMMALVL2;
import static config.language.englsh.GAMMALVL3;
import static config.language.englsh.GAMMALVL4;
import static config.language.englsh.LOADNET;
import static config.language.englsh.MSGOFF;
import static config.language.englsh.MSGON;
import static config.language.englsh.NETEND;
import static config.language.englsh.NEWGAME;
import static config.language.englsh.NIGHTMARE;
import static config.language.englsh.QLOADNET;
import static config.language.englsh.QLPROMPT;
import static config.language.englsh.QSAVESPOT;
import static config.language.englsh.QSPROMPT;
import static config.language.englsh.SAVEDEAD;
import static config.language.englsh.SWSTRING;
import doom.event_t;
